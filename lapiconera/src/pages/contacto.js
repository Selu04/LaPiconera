                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Tu cuenta tiene restricciones y no puedes utilizar el formulario de contacto. Si consideras que esto es un error, por favor acude a nuestro negocio físico para resolverlo. Gracias.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-red-800 mb-2">Acceso Restringido</h3>
                      <p className="text-gray-700">
                        Tu cuenta tiene restricciones y no puedes enviar sugerencias. Si consideras que esto es un error, por favor acude a nuestro negocio físico para resolverlo. Gracias.
                      </p>
                    </div>
                  </div>
                </div>
